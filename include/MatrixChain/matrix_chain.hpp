...
namespace matrix_chain {
    ...
    class matrix_chain_t final : private detail::dp_chain_t {
    ...
    public:
        ...
        std::pair<matrix_t<ElemT>, unsigned long long> multiply_chain_fast() const {
        ...
        unsigned long long get_cost_mult_naive() const {
            unsigned long long cost = 0;
            for (int i = 1, end = matrices.size(); i < end; ++i)
